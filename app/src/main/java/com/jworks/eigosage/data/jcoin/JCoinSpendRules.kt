package com.jworks.eigosage.data.jcoin
...
/**
 * EigoSage J Coin spend rules — daily free quotas, streak freezes, theme unlocks.
 *
 * SPEND ITEMS:
...
class JCoinSpendRules @Inject constructor() {
    ...
    companion object {
        private const val PREFS_NAME = "eigosage_jcoin"
